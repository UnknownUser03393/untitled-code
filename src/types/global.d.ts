...
// ============================================================================
// Bun runtime global — under Node all references are inside
// `typeof Bun !== 'undefined'` guards, so this is resolved but never called.
// Declared as `any` to keep tsc from failing on the identifier itself.
